...
/* === 2026 GRAND MAISON — COMPLETE LUXURY REBUILD === */
...
</style></head><body><div class="luxDust" id="luxDust"></div><div class="chandelier left"></div><div class="chandelier right"></div><div class="luxFloor"></div><div class="goldCrest">GRAND MAISON</div><div class="mantel"><i class="mc" style="--h:34px"></i><i class="mc" style="--h:48px"></i><i class="mc" style="--h:27px"></i><i class="mc" style="--h:41px"></i></div><div class="luxHalo" id="luxHalo"></div>
