...
function toggleKeyboard(){let k=document.getElementById("virtualKeyboard"),sh=document.getElementById("kbdShade");let on=!k.classList.contains("show");k.classList.toggle("show",on);sh.classList.toggle("show",on);document.getElementById("keySearch").focus()}
function closeKeyboard(){document.getElementById("virtualKeyboard").classList.remove("show");document.getElementById("kbdShade").classList.remove("show")}
