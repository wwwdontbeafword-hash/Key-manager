...
/* === CHETO GOLDEN ESTATE / MODERN LUXURY THEME === */
:root{--gold:#d9aa55;--champ:#f2d89a;--amber:#ffb347;--espresso:#120d08;--ivory:#fff8e8;--wine:#29150d}
html,body{background:#0d0906!important;color:var(--ivory)!important}
body{background:radial-gradient(circle at 14% 5%,#8a55252b,transparent 28%),radial-gradient(circle at 88% 12%,#c58b3a20,transparent 27%),linear-gradient(135deg,#090603,#171009 46%,#0b0704)!important}
body:before{content:"";position:fixed;inset:0;pointer-events:none;z-index:-1;background:linear-gradient(115deg,transparent 0 42%,#ffd98a09 48%,transparent 54%),repeating-linear-gradient(90deg,#ffffff05 0 1px,transparent 1px 92px);opacity:.65}
.scene{background:radial-gradient(circle at 20% 20%,#b96e2633,transparent 30%),radial-gradient(circle at 78% 72%,#f2c66c1c,transparent 27%),linear-gradient(145deg,#080503,#1a1009)!important}.grid{opacity:.06!important;background-image:linear-gradient(#e5b45a22 1px,transparent 1px),linear-gradient(90deg,#e5b45a22 1px,transparent 1px)!important}.orb{background:#d7973b20!important;box-shadow:0 0 120px #e3a54835!important}
.wrap,.card,.serverCard,.keys,.logsPage,.statCard,.pageHero,.fx,.insight,.loginExtra,.logWrap,.logTimer{border-color:#9d74373d!important;background:linear-gradient(145deg,#1b130cF2,#0d0906F5)!important;box-shadow:0 24px 70px #0009,inset 0 1px 0 #f7d99914!important}
.wrap{border-radius:34px!important;box-shadow:0 45px 120px #000d,0 0 0 1px #d5a34f24,0 0 90px #d99a3820!important}.visual{background:linear-gradient(145deg,#21150b,#0c0805)!important}.login{background:linear-gradient(155deg,#1b120bF0,#0b0805FA)!important}
.kicker,.eyebrow{color:#d7a957!important}.login h2,.title,.brand h1{font-family:Georgia,'Times New Roman',serif;letter-spacing:-1px!important}.brand small{color:#e6c883!important}.live,.status.on,.updateBadge.clear{color:#f2d58e!important;border-color:#b7833f55!important;background:#2b1d0daa!important}.dot,.miniDot,.heroLive i,.sysPill i{background:#e8b85e!important;box-shadow:0 0 15px #e8b85e!important}
.field input,input,textarea{background:#0b0704!important;border-color:#6e512d!important;color:#fff8e8!important}.field input:focus,input:focus,textarea:focus{border-color:#d4a24e!important;box-shadow:0 0 0 4px #d6a24d18,0 0 32px #d6a24d18!important}.submit,.primary{background:linear-gradient(105deg,#6f431b,#d6a44d,#8a5724)!important;color:#120b05!important;box-shadow:0 14px 38px #c58b3b25!important}.submit:before{background:#fff4c65c!important}
.lang,.lang button,.menuBtn,.toolBtn,.filterChip,.action button,.editClose,.heroTools button{background:#130d08!important;border-color:#73532d!important;color:#e9d29d!important}.filterChip.active{background:#3a260f!important;border-color:#d0a04e!important;color:#ffe6a9!important}.drawer{background:linear-gradient(180deg,#181008,#090604)!important;border-color:#7e5c31!important}.avatar2{background:radial-gradient(circle at 35% 30%,#f6d47e,#b87927 55%,#4c2c0d)!important;color:#241306!important;box-shadow:0 0 40px #d39b4555!important}.nav a.active{background:#34210d!important;color:#f1ce82!important}.nav a.active:before{background:#e4b55d!important;box-shadow:0 0 12px #e4b55d!important}
.hero-border,.motion-border{background:linear-gradient(110deg,#4c3015,#e2b45c,#5a3818)!important}.hero-border:before{color:#f4d892!important;border-color:#8b6535!important;background:#100b07d9!important}.hero-border:after{color:#f2d28a!important;border-color:#9b7138!important;background:#281a0dcc!important}
th{color:#bda77a!important}td{border-color:#2e2115!important}.keyicon.on{color:#f1c56c!important;background:#38230e!important;border-color:#e0ac56aa!important;box-shadow:0 0 12px #e0ac5677,0 0 30px #b9782944!important}.keyicon.off{color:#b98b58!important;background:#24170d!important;border-color:#7f5d3e!important;box-shadow:none!important}.status.on{color:#f0c66e!important;background:#35230f!important}.reset button,.edit button{color:#efd28f!important;border-color:#7d5c32!important;background:linear-gradient(145deg,#20150c,#0e0906)!important}.beam,.logProgress{background:linear-gradient(90deg,transparent,#c88c38,#f4d27f,#c88c38,transparent)!important;box-shadow:0 0 15px #d9a34f!important}.lamp{background:#3b280f!important;border-color:#e1b25b!important;box-shadow:0 0 28px #dba54f55!important}.toast{border-color:#806037!important;background:#171008ef!important;box-shadow:0 18px 55px #000b,0 0 30px #c58b3922!important}.toastIcon{background:linear-gradient(135deg,#704319,#e0b159)!important;color:#160d05!important}
/* Useful pixel candle: ambient-light control */
.pixelCandle{position:fixed;right:18px;bottom:18px;z-index:220;width:72px;height:96px;border:1px solid #8f6838;border-radius:18px;background:#120c08e8;box-shadow:0 18px 45px #000b,0 0 25px #c57d2730;cursor:pointer;display:grid;place-items:center;transition:.25s;backdrop-filter:blur(10px)}.pixelCandle:hover{transform:translateY(-4px);border-color:#e0b25e}.pxc{position:relative;width:38px;height:66px;image-rendering:pixelated}.wax{position:absolute;left:10px;bottom:4px;width:20px;height:38px;background:#ead8b5;box-shadow:4px 0 #bfa57a,-4px 8px #fff0ce,0 0 18px #ffb34a55}.wick{position:absolute;left:18px;bottom:42px;width:4px;height:8px;background:#392316}.flame{position:absolute;left:13px;bottom:49px;width:14px;height:18px;background:#ffcf57;clip-path:polygon(50% 0,100% 60%,75% 100%,25% 100%,0 60%);box-shadow:0 0 12px #ff9e2f,0 0 28px #ff8c1f;animation:candleFlicker 1.25s steps(2) infinite}.flame:after{content:"";position:absolute;left:4px;bottom:2px;width:6px;height:9px;background:#fff0a6}.pixelCandle small{position:absolute;bottom:5px;font:800 6px monospace;letter-spacing:1px;color:#a98d61}@keyframes candleFlicker{50%{transform:translateX(1px) scaleY(.88);filter:brightness(1.18)}}body.candleDim{filter:saturate(.9)}body.candleDim:after{content:"";position:fixed;inset:0;z-index:210;pointer-events:none;background:radial-gradient(circle at calc(100% - 52px) calc(100% - 65px),#ffb13b24 0 8%,#0804016b 42%,#030201a8 100%);animation:roomGlow 2.3s ease-in-out infinite alternate}@keyframes roomGlow{to{background:radial-gradient(circle at calc(100% - 52px) calc(100% - 65px),#ffc45b32 0 10%,#08040166 45%,#030201a4 100%)}}body.candleDim .pixelCandle{z-index:230;box-shadow:0 0 45px #ff9e365e,0 18px 45px #000b}.candleDim .flame{background:#ff9f35}
@media(max-width:600px){.pixelCandle{width:60px;height:82px;right:12px;bottom:12px}.pxc{transform:scale(.82)}}

/* === 2026 RAMADAN MAJLIS — COMPLETE LUXURY REBUILD === */
:root{--ink:#160e08;--brown:#2b190c;--mahogany:#3a2110;--gold:#d9a441;--gold2:#f5d98c;--cream:#fff6df;--amber:#ffb43b;--glass:rgba(31,18,9,.84)}
html,body{background:#120b06!important;color:var(--cream)!important;font-family:Inter,Arial,sans-serif!important}
body{background:radial-gradient(circle at 15% 0,#7b451d55,transparent 28%),radial-gradient(circle at 90% 15%,#e2a84722,transparent 22%),linear-gradient(135deg,#0b0704,#241307 48%,#100905)!important;background-attachment:fixed!important}
.scene{background:linear-gradient(180deg,#160d07aa,#080503dd),radial-gradient(circle at 50% 15%,#ffbd4b26,transparent 28%)!important}.grid,.orb{display:none!important}
/* architectural background */
body:before{content:"";position:fixed;inset:0;pointer-events:none;z-index:-1;background:linear-gradient(90deg,transparent 8%,#e8c1740a 8.1%,transparent 8.25%,transparent 91.7%,#e8c1740a 91.9%,transparent 92%),repeating-linear-gradient(90deg,transparent 0 118px,#f5d68b08 119px 120px),linear-gradient(115deg,transparent 42%,#ffd77a08 49%,transparent 56%)}
/* gold dust */
.luxDust{position:fixed;inset:0;z-index:0;pointer-events:none;overflow:hidden}.luxDust i{position:absolute;width:2px;height:2px;background:#ffd97c;border-radius:50%;box-shadow:0 0 8px #ffb53d;animation:dustFloat var(--t,9s) ease-in-out infinite alternate;opacity:var(--o,.35)}@keyframes dustFloat{to{transform:translate3d(var(--x,18px),-45px,0);opacity:.08}}
/* chandeliers */
.chandelier{position:fixed;top:-4px;z-index:1;width:130px;height:115px;pointer-events:none;filter:drop-shadow(0 0 18px #ffb63755)}.chandelier.left{left:4vw}.chandelier.right{right:4vw;transform:scaleX(-1)}.chandelier:before{content:"";position:absolute;left:64px;top:0;width:2px;height:44px;background:linear-gradient(#7c531d,#f2c66c)}.chandelier:after{content:"✦  ✦  ✦";position:absolute;left:18px;top:38px;width:96px;text-align:center;color:#ffd77d;font-size:24px;letter-spacing:5px;text-shadow:0 0 8px #ffb238,0 0 22px #ff9d20}
/* marble floor glow */
.luxFloor{position:fixed;left:0;right:0;bottom:0;height:20vh;z-index:-1;pointer-events:none;background:linear-gradient(180deg,transparent,#c68a3420),repeating-linear-gradient(100deg,transparent 0 140px,#f5dba30a 142px 143px);transform:perspective(500px) rotateX(63deg);transform-origin:bottom}
/* panels become bespoke furniture */
.wrap{max-width:1320px!important}.wrap,.card,.serverCard,.keys,.logsPage,.statCard,.pageHero,.fx,.insight,.logWrap,.logTimer{border:1px solid #c894403f!important;background:linear-gradient(145deg,#2b190df2,#120b07f5)!important;box-shadow:0 24px 70px #0009,inset 0 1px 0 #ffe4a526!important}
.card,.serverCard,.statCard,.fx,.insight,.pageHero,.keys,.logWrap{border-radius:22px!important}.card:hover,.serverCard:hover,.statCard:hover,.fx:hover{transform:translateY(-3px)!important;border-color:#e3b65c80!important;box-shadow:0 28px 75px #000a,0 0 34px #d7973420!important}
.top{border-color:#b37d3538!important}.title,.login h2,.brand h1,.pageHero h2,.card h3,.serverCard h2{font-family:Georgia,'Times New Roman',serif!important}.title{font-size:36px!important}.eyebrow,.kicker{color:#e1b55f!important;letter-spacing:3.5px!important}
/* login: asymmetrical luxury residence */
.wrap:has(.login){width:min(1120px,94vw)!important;grid-template-columns:1.18fr .82fr!important;border-radius:42px!important;background:#160d08e8!important;border:1px solid #d3a04b55!important;box-shadow:0 55px 140px #000e,0 0 0 8px #0c0704aa,0 0 90px #d59a3522!important}.visual{min-height:650px!important;padding:0!important;background:#130b06!important}.photo{min-height:650px!important;border-radius:0!important}.photo img{filter:sepia(.2) saturate(.8) contrast(1.06);-webkit-mask-image:linear-gradient(to bottom,#000 0%,#000 72%,transparent 100%)!important}.login{padding:84px 58px 48px!important;background:radial-gradient(circle at 100% 0,#bd7c2820,transparent 30%),linear-gradient(155deg,#2a190ff7,#100a06fa)!important}.login:before{content:"PRIVATE RESIDENCE • EST. MMXXVI";position:absolute;right:28px;bottom:20px;color:#9e7a49;font:700 7px monospace;letter-spacing:2px}.brand{left:46px!important;bottom:46px!important}.brand h1{font-size:43px!important;color:#fff0c4}.brand small{color:#e3bd73!important}.field input{height:62px!important;border-radius:4px!important;background:#0d0805!important;border:1px solid #765328!important}.submit,.primary{border-radius:4px!important;background:linear-gradient(100deg,#714414,#e0b35a,#8b561d)!important;color:#160d06!important;box-shadow:0 14px 35px #d1943226!important}.lang{border-radius:4px!important}.loginQuick div{border-radius:4px!important;background:#170e09!important;border-color:#6d4c27!important}
/* dashboard reflow */
.dashGrid{grid-template-columns:1.25fr 1fr 1fr!important}.statCard:nth-child(1){grid-row:span 2;min-height:190px;display:flex;flex-direction:column;justify-content:center}.statCard:nth-child(1) strong{font-size:54px!important}.featureDeck{grid-template-columns:repeat(5,1fr)!important}.fx{min-height:112px!important}.keys{overflow:hidden!important}.keyTools{background:linear-gradient(180deg,#28170d,#120b07)!important}.searchBox input,.toolBtn,input,textarea{border-radius:8px!important;background:#0f0906!important;border-color:#684921!important}.filterChip{border-radius:4px!important}.filterChip.active{background:#6b4218!important;color:#ffe7ac!important;border-color:#d7a54c!important}
/* drawer becomes private-club rail */
.drawer{background:linear-gradient(180deg,#2a190f,#0e0906)!important;border-left:1px solid #bd8b3d66!important;box-shadow:-35px 0 90px #000d!important}.avatar2{border-radius:8px!important;background:linear-gradient(145deg,#f0cf7a,#9a6424)!important;color:#251407!important}.nav a{border-radius:5px!important}.nav a.active{background:linear-gradient(90deg,#6c431b88,transparent)!important;color:#f4d68d!important}.nav a.active:before{border-radius:0!important;background:#f0c66c!important}
/* tables */
th{background:#170e09;color:#c9a66c!important}td{border-color:#3d2917!important}.keyicon{border-radius:8px!important}.keyicon.on{color:#f4cf76!important;background:#3b250e!important;border-color:#d8a54d!important}.status{border-radius:4px!important}.status.on{color:#f1ce79!important;background:#3a260f!important}.action button,.reset button,.edit button{border-radius:5px!important}
/* decorative corner engraving */
.card:after,.serverCard:after,.statCard:after,.pageHero:after,.fx:after{content:"✦"!important;position:absolute!important;right:13px!important;top:9px!important;width:auto!important;height:auto!important;background:none!important;color:#d8aa5466!important;font-size:13px!important;box-shadow:none!important}.card,.serverCard,.statCard,.pageHero,.fx{position:relative!important}
/* functional candle console */
.pixelCandle{width:84px!important;height:112px!important;border-radius:7px!important;border:1px solid #b9863d!important;background:linear-gradient(145deg,#29170d,#100905)!important}.pixelCandle small{color:#d9b36e!important}.flame{animation:candleFlicker .9s steps(2) infinite!important}.wax{background:#f4e2bd!important}
/* little mantel candles */
.mantel{position:fixed;z-index:2;bottom:18px;left:18px;display:flex;align-items:flex-end;gap:9px;pointer-events:none}.mc{display:block;width:11px;height:var(--h);background:linear-gradient(90deg,#bfa67b,#fff0ce,#bca078);box-shadow:0 0 15px #ffad3555;position:relative}.mc:before{content:"";position:absolute;left:2px;top:-13px;width:7px;height:12px;background:#ffb53d;clip-path:polygon(50% 0,100% 65%,70% 100%,30% 100%,0 65%);box-shadow:0 0 10px #ff9d28}
/* gold crest */
.goldCrest{position:fixed;z-index:2;left:50%;top:10px;transform:translateX(-50%);color:#d9ae61;font:700 9px Georgia;letter-spacing:5px;opacity:.65;pointer-events:none}.goldCrest:before,.goldCrest:after{content:"◆";margin:0 12px;color:#8e612d}
/* cursor halo */
.luxHalo{position:fixed;width:180px;height:180px;border-radius:50%;pointer-events:none;z-index:1;background:radial-gradient(circle,#ffc45b10,transparent 65%);transform:translate(-50%,-50%);transition:left .12s,top .12s}
@media(max-width:760px){.chandelier{display:none}.goldCrest{font-size:7px;letter-spacing:2px}.wrap:has(.login){grid-template-columns:1fr!important}.visual{min-height:310px!important}.photo{min-height:310px!important}.login{padding:78px 28px 42px!important}.dashGrid{grid-template-columns:1fr 1fr!important}.featureDeck{grid-template-columns:1fr 1fr!important}.mantel{display:none}}

/* === RAMADAN NOOR 2026 — FULL CELEBRATION THEME === */
:root{--ramadan-gold:#f5c85b;--ramadan-gold2:#fff0ad;--ramadan-green:#0d5b4b;--ramadan-night:#071b27;--ramadan-indigo:#10243d;--ramadan-glass:rgba(6,27,35,.86)}
html,body{background:#04131c!important;color:#fff8df!important}
body{background:radial-gradient(circle at 50% -10%,#2a7a6855,transparent 31%),radial-gradient(circle at 8% 25%,#d49a2930,transparent 23%),radial-gradient(circle at 92% 70%,#1c6b6635,transparent 25%),linear-gradient(145deg,#031018,#082631 50%,#04131c)!important;background-attachment:fixed!important}
body:before{content:""!important;position:fixed!important;inset:0!important;z-index:-2!important;pointer-events:none!important;background-image:radial-gradient(circle,#ffe29b 0 1px,transparent 1.5px),radial-gradient(circle,#fff4c5 0 1px,transparent 1.5px),linear-gradient(120deg,transparent 0 48%,#f6c85a08 50%,transparent 52%)!important;background-size:83px 83px,131px 131px,100% 100%!important;background-position:0 0,35px 52px,0 0!important;animation:ramadanStars 18s linear infinite!important;opacity:.8!important}
@keyframes ramadanStars{to{background-position:83px 83px,-96px 183px,0 0}}
.scene{background:radial-gradient(circle at 50% 8%,#f4c75824,transparent 24%),linear-gradient(180deg,#04131c99,#031017ee)!important}.grid,.orb{display:none!important}
.wrap,.card,.serverCard,.keys,.logsPage,.statCard,.pageHero,.fx,.insight,.loginExtra,.logWrap,.logTimer{background:linear-gradient(145deg,#092a31ee,#061b25f5)!important;border:1px solid #e8c15b42!important;box-shadow:0 25px 75px #0009,inset 0 1px 0 #fff3bd20,0 0 35px #e4b84b0d!important}
.wrap{border-radius:28px!important}.card,.serverCard,.statCard,.pageHero,.fx,.insight,.keys,.logWrap{border-radius:20px!important}
.visual{background:linear-gradient(145deg,#0b3135,#051923)!important}.login{background:radial-gradient(circle at 100% 0,#e9bd4a1c,transparent 32%),linear-gradient(155deg,#0b3036f7,#061923fa)!important}
.title,.login h2,.brand h1,.pageHero h2,.card h3,.serverCard h2{font-family:Georgia,'Times New Roman',serif!important;color:#fff5d0!important}.eyebrow,.kicker,.brand small{color:#f1c85f!important}.dot,.miniDot,.heroLive i,.sysPill i{background:#f5ca61!important;box-shadow:0 0 16px #f5ca61!important}
.field input,input,textarea{background:#04171f!important;border-color:#b18d3f66!important;color:#fff8df!important}.field input:focus,input:focus,textarea:focus{border-color:#f1c85f!important;box-shadow:0 0 0 4px #f1c85f16,0 0 30px #f1c85f18!important}
.submit,.primary{background:linear-gradient(105deg,#0a6a58,#e0b447,#0a6a58)!important;background-size:220% 100%!important;color:#fff8df!important;box-shadow:0 14px 40px #d9aa3c25!important;animation:ramadanBtn 4s linear infinite!important}@keyframes ramadanBtn{to{background-position:220% 0}}
.lang,.lang button,.menuBtn,.toolBtn,.filterChip,.action button,.editClose,.heroTools button{background:#071e27!important;border-color:#9c7b3c66!important;color:#f6ddb0!important}.filterChip.active{background:#124c43!important;border-color:#efc65d!important;color:#fff0b8!important}.drawer{background:linear-gradient(180deg,#092b31,#04151e)!important;border-color:#b9913f66!important}.avatar2{background:radial-gradient(circle at 35% 30%,#fff1ae,#d1a238 55%,#0c5b4c)!important;color:#173229!important;box-shadow:0 0 38px #e5bb4c55!important}.nav a.active{background:#10483f!important;color:#ffe99c!important}.nav a.active:before{background:#f1c65b!important;box-shadow:0 0 13px #f1c65b!important}
th{color:#d9bd78!important}td{border-color:#15353c!important}.keyicon.on{color:#ffe37c!important;background:#164c3c!important;border-color:#e9c354aa!important;box-shadow:0 0 14px #e9c35466!important}.status.on{color:#ffe49a!important;background:#16463b!important}.beam,.logProgress{background:linear-gradient(90deg,transparent,#0d8a73,#f4cf69,#0d8a73,transparent)!important;box-shadow:0 0 17px #efc85b!important}.lamp{background:#10493c!important;border-color:#f1ca62!important;box-shadow:0 0 28px #e8c05255!important}.toast{border-color:#b08d4566!important;background:#071e27f2!important;box-shadow:0 18px 55px #000b,0 0 30px #e6bd4b22!important}.toastIcon{background:linear-gradient(135deg,#0b6957,#efc65d)!important;color:#08251f!important}
/* animated Ramadan stage */
.ramadanStage{position:fixed;inset:0;z-index:0;pointer-events:none;overflow:hidden}.ramadanStage:before{content:"☾";position:absolute;right:6vw;top:4vh;font:110px Georgia;color:#ffe486;text-shadow:0 0 18px #ffd65b,0 0 60px #e6a72f55;animation:moonFloat 6s ease-in-out infinite}.ramadanStage:after{content:"✦   ✧   ✦";position:absolute;right:5vw;top:18vh;color:#fff0a7;font-size:18px;letter-spacing:13px;text-shadow:0 0 12px #ffd96c;animation:twinkle 2.4s ease-in-out infinite}@keyframes moonFloat{50%{transform:translateY(10px) rotate(-4deg)}}@keyframes twinkle{50%{opacity:.3;transform:scale(.92)}}
.ramadanLanterns{position:fixed;left:0;right:0;top:0;height:180px;z-index:1;pointer-events:none;background:linear-gradient(90deg,transparent 0 3%,#d9ae4d66 3.1% 3.2%,transparent 3.3% 96.7%,#d9ae4d66 96.8% 96.9%,transparent 97%)}.rLantern{position:absolute;top:0;width:2px;height:var(--drop);background:linear-gradient(#c99d43,#76551f)}.rLantern:after{content:"";position:absolute;left:-13px;bottom:-38px;width:28px;height:38px;border:2px solid #e8bd59;border-radius:10px 10px 14px 14px;background:radial-gradient(circle,#fff0a4 0 10%,#f2b83f55 35%,#0b4b42aa 70%);box-shadow:0 0 18px #ffc94d,0 0 45px #e6aa3855;clip-path:polygon(25% 0,75% 0,100% 24%,85% 100%,15% 100%,0 24%);animation:lanternSwing var(--speed) ease-in-out infinite alternate;transform-origin:50% -35px}@keyframes lanternSwing{to{transform:rotate(var(--rot)) translateX(3px);filter:brightness(1.2)}}
.ramadanMosque{position:fixed;left:0;right:0;bottom:-2px;height:150px;z-index:0;pointer-events:none;opacity:.42;background:linear-gradient(to top,#020b10 0 55%,transparent 56%)}.ramadanMosque:before{content:"";position:absolute;left:8%;right:8%;bottom:55px;height:85px;background:#020b10;clip-path:polygon(0 100%,0 70%,4% 70%,4% 30%,5% 18%,6% 30%,6% 70%,18% 70%,20% 48%,22% 36%,24% 48%,26% 70%,42% 70%,44% 42%,47% 22%,50% 10%,53% 22%,56% 42%,58% 70%,74% 70%,76% 48%,78% 36%,80% 48%,82% 70%,94% 70%,94% 30%,95% 18%,96% 30%,96% 70%,100% 70%,100% 100%)}
.ramadanParticles{position:fixed;inset:0;z-index:0;pointer-events:none;overflow:hidden}.ramadanParticles i{position:absolute;width:3px;height:3px;border-radius:50%;background:#ffe188;box-shadow:0 0 10px #ffc84f;animation:ramadanDust var(--dur) linear infinite;opacity:var(--op)}@keyframes ramadanDust{0%{transform:translateY(105vh) scale(.4)}100%{transform:translateY(-15vh) translateX(var(--dx)) scale(1.2)}}
/* universal motion: cards, menus, forms, rows */
.card,.serverCard,.statCard,.fx,.insight,.pageHero,.keys,.logWrap,.hero-border,.motion-border{animation:ramadanReveal .65s cubic-bezier(.16,.9,.2,1) both}@keyframes ramadanReveal{from{opacity:0;transform:translateY(24px) scale(.975);filter:blur(7px)}to{opacity:1;transform:none;filter:none}}
.card:hover,.serverCard:hover,.statCard:hover,.fx:hover,.insight:hover{transform:translateY(-5px) scale(1.008)!important;border-color:#efca6c88!important;box-shadow:0 30px 80px #000a,0 0 35px #f0c75a18!important;transition:.32s cubic-bezier(.2,.8,.2,1)!important}
.drawer.show .nav a{animation:navRamadan .45s both}.drawer.show .nav a:nth-child(2){animation-delay:.05s}.drawer.show .nav a:nth-child(3){animation-delay:.1s}.drawer.show .nav a:nth-child(4){animation-delay:.15s}.drawer.show .nav a:nth-child(5){animation-delay:.2s}@keyframes navRamadan{from{opacity:0;transform:translateX(28px)}to{opacity:1;transform:none}}
tr{transition:.25s}tbody tr:hover{background:#e9bd4a09;transform:scale(1.002)}button{transition:transform .2s,filter .2s,box-shadow .2s!important}button:active{transform:scale(.96)!important}.menuBtn:hover,.toolBtn:hover{box-shadow:0 0 24px #f0c75a2e!important;filter:brightness(1.18)}
/* loading / sabr overlay */
.ramadanLoader{position:fixed;inset:0;z-index:9999;display:grid;place-items:center;background:radial-gradient(circle at 50% 38%,#0e584b,#061c27 42%,#020b10);transition:opacity .7s,visibility .7s}.ramadanLoader.hide{opacity:0;visibility:hidden;pointer-events:none}.loaderCore{text-align:center;animation:loaderIn .7s ease both}@keyframes loaderIn{from{opacity:0;transform:scale(.8) translateY(20px)}}.loaderMoon{position:relative;width:96px;height:96px;margin:auto;border-radius:50%;box-shadow:-22px 12px 0 0 #f7d66f;animation:loaderMoon 2.4s ease-in-out infinite;filter:drop-shadow(0 0 16px #f4c85b)}@keyframes loaderMoon{50%{transform:rotate(-12deg) scale(1.08)}}.loaderLantern{width:34px;height:50px;margin:5px auto 20px;border:2px solid #f1c65c;border-radius:10px;background:radial-gradient(circle,#fff4b8,#e8b34266 45%,#0d5a4c 75%);box-shadow:0 0 22px #ffc84f;animation:loaderLantern 1.2s ease-in-out infinite alternate}@keyframes loaderLantern{to{transform:translateY(-7px);box-shadow:0 0 38px #ffd86e}}.loaderCore b{display:block;font:700 25px Georgia;color:#fff1b2;letter-spacing:1px}.loaderCore small{display:block;margin-top:8px;color:#c8b98d;font-size:10px;letter-spacing:2px}.sabrDots{display:flex;justify-content:center;gap:7px;margin-top:18px}.sabrDots i{width:7px;height:7px;border-radius:50%;background:#f3ca62;animation:sabrDot 1.1s infinite}.sabrDots i:nth-child(2){animation-delay:.15s}.sabrDots i:nth-child(3){animation-delay:.3s}@keyframes sabrDot{50%{transform:translateY(-8px);opacity:.35}}
/* click ripple */
.ramadanRipple{position:fixed;border-radius:50%;pointer-events:none;z-index:9998;border:1px solid #ffe69a;background:#f5c95b25;transform:translate(-50%,-50%) scale(0);animation:rippleRam .7s ease-out forwards}@keyframes rippleRam{to{transform:translate(-50%,-50%) scale(8);opacity:0}}
@media(max-width:760px){.ramadanStage:before{font-size:70px;right:2vw;top:6vh}.ramadanLanterns{height:120px}.ramadanMosque{height:100px}.rLantern:nth-child(even){display:none}.wrap{position:relative;z-index:2}}
@media(prefers-reduced-motion:reduce){*,*:before,*:after{animation-duration:.01ms!important;animation-iteration-count:1!important;scroll-behavior:auto!important}}

/* === RAMADAN PALACE 2026 — FULL REBUILD === */
:root{--ram-bg:#03110d;--ram-deep:#061b14;--ram-green:#0b3a28;--ram-gold:#f4c96b;--ram-gold2:#ffe8a7;--ram-cream:#fff7dd;--ram-line:#c89a4355}
html,body{background:#020b08!important;color:var(--ram-cream)!important}
body{background:radial-gradient(circle at 50% -15%,#f2c75b1c,transparent 32%),radial-gradient(circle at 8% 20%,#0f70473b,transparent 28%),radial-gradient(circle at 92% 70%,#8a5d1426,transparent 30%),linear-gradient(145deg,#020906,#071b13 52%,#020906)!important;background-attachment:fixed!important}
body:before{content:""!important;position:fixed!important;inset:0!important;z-index:-2!important;pointer-events:none!important;background:linear-gradient(180deg,transparent 0 72%,#020704 72%),repeating-linear-gradient(90deg,transparent 0 119px,#f7d77b08 120px),radial-gradient(ellipse at 50% 100%,#dcae4314,transparent 55%)!important}
.scene{background:radial-gradient(circle at 50% 5%,#f9d87c1b,transparent 25%),linear-gradient(180deg,#03110dcf,#020806f5)!important}.grid,.orb,.chandelier,.luxFloor,.goldCrest,.mantel,.luxHalo,.pixelCandle{display:none!important}
.ramadanSky{position:fixed;inset:0;z-index:0;pointer-events:none;overflow:hidden}.ramadanSky:before{content:"";position:absolute;inset:0;background-image:radial-gradient(circle,#ffe8a7 0 1px,transparent 1.5px);background-size:83px 83px;opacity:.22;animation:ramStars 7s ease-in-out infinite alternate}@keyframes ramStars{50%{opacity:.5;transform:translateY(-7px)}}
.ramMoon{position:fixed;z-index:1;right:5vw;top:4vh;width:118px;height:118px;border-radius:50%;background:#f8dc8a;box-shadow:0 0 18px #ffe39a,0 0 55px #f3c75a66,0 0 120px #eeb94b33;animation:moonFloat 5s ease-in-out infinite}.ramMoon:after{content:"";position:absolute;width:105px;height:105px;left:31px;top:-8px;border-radius:50%;background:#03100c;box-shadow:inset 12px 0 20px #0b2a1d55}@keyframes moonFloat{50%{transform:translateY(8px) rotate(2deg)}}
.ramStar{position:fixed;z-index:1;right:4.2vw;top:17vh;color:#f8d77b;font-size:28px;text-shadow:0 0 18px #ffd66d;animation:starPulse 1.8s ease-in-out infinite}@keyframes starPulse{50%{transform:scale(.75) rotate(14deg);opacity:.55}}
.ramMosque{position:fixed;left:0;right:0;bottom:0;height:155px;z-index:0;pointer-events:none;opacity:.38;background:linear-gradient(90deg,transparent 0 4%,#020604 4% 7%,transparent 7% 13%,#020604 13% 16%,transparent 16% 84%,#020604 84% 87%,transparent 87% 93%,#020604 93% 96%,transparent 96%)}.ramMosque:before{content:"";position:absolute;left:50%;bottom:0;transform:translateX(-50%);width:min(650px,80vw);height:110px;background:#020604;clip-path:polygon(0 100%,0 58%,7% 58%,7% 42%,10% 42%,10% 28%,12% 28%,12% 42%,15% 42%,15% 60%,26% 60%,26% 47%,31% 47%,35% 28%,39% 47%,43% 47%,43% 61%,47% 61%,47% 42%,50% 19%,53% 42%,53% 61%,57% 61%,57% 47%,61% 47%,65% 28%,69% 47%,74% 47%,74% 60%,85% 60%,85% 42%,88% 42%,88% 28%,90% 28%,90% 42%,93% 42%,93% 58%,100% 58%,100% 100%)}
.ramLantern{position:fixed;z-index:3;top:-8px;width:52px;height:105px;pointer-events:none;transform-origin:top center;animation:lanternSwing 3.6s ease-in-out infinite alternate;filter:drop-shadow(0 0 15px #ffc85b88)}.ramLantern.l1{left:5vw}.ramLantern.l2{left:16vw;animation-delay:-1.1s;transform:scale(.78)}.ramLantern.r1{right:16vw;animation-delay:-2.1s;transform:scale(.78)}.ramLantern.r2{right:5vw;animation-delay:-.6s}.ramLantern:before{content:"";position:absolute;left:25px;top:0;width:2px;height:30px;background:#b98b39}.ramLantern:after{content:"✦";position:absolute;left:8px;top:28px;width:36px;height:52px;display:grid;place-items:center;color:#fff1b8;font-size:20px;border:2px solid #d9a844;background:linear-gradient(145deg,#3f2b10,#f0b84255,#143b27);clip-path:polygon(20% 0,80% 0,100% 25%,86% 100%,14% 100%,0 25%);box-shadow:inset 0 0 18px #ffc95288,0 0 28px #ffc95266}@keyframes lanternSwing{from{rotate:-4deg}to{rotate:4deg}}
.ramParticles{position:fixed;inset:0;z-index:1;pointer-events:none;overflow:hidden}.ramParticles i{position:absolute;color:#f6cf70;opacity:.2;animation:ramRise var(--t) linear infinite;font-style:normal;text-shadow:0 0 9px #f6cf70}@keyframes ramRise{from{transform:translateY(105vh) rotate(0);opacity:0}15%{opacity:.45}to{transform:translateY(-15vh) rotate(160deg);opacity:0}}
.wrap,.card,.serverCard,.keys,.logsPage,.statCard,.pageHero,.fx,.insight,.loginExtra,.logWrap,.logTimer,.editCard{border-color:var(--ram-line)!important;background:linear-gradient(145deg,#082219eF,#03100cF7)!important;box-shadow:0 24px 70px #000b,inset 0 1px 0 #ffe7a51c!important}
.wrap{border-radius:26px!important;box-shadow:0 35px 100px #000d,0 0 0 1px #e0b6532c,0 0 90px #0a9b5d18!important}.visual,.login{background:linear-gradient(145deg,#0b2b1e,#04110d)!important}.login:before{content:"RAMADAN KAREEM • رمضان كريم"!important;color:#dcb65f!important}.brand h1{color:#ffe7a3!important}.brand small,.kicker,.eyebrow{color:#e8c46f!important}.brand h1:after{content:"  ☾";color:#f4d06f;text-shadow:0 0 15px #f4d06f}
.title,.login h2,.brand h1,.pageHero h2,.card h3,.serverCard h2{font-family:Georgia,'Times New Roman',serif!important}.title:after{content:"  ☾";color:#eac45f}.live,.status.on,.updateBadge.clear{color:#f4d57f!important;border-color:#d2a94d66!important;background:#0c3524cc!important}.dot,.miniDot,.heroLive i,.sysPill i{background:#f1c85e!important;box-shadow:0 0 15px #f1c85e!important}
input,textarea,.field input{background:#03100c!important;border-color:#856b35!important;color:#fff5d2!important}.field input:focus,input:focus,textarea:focus{border-color:#f0c65f!important;box-shadow:0 0 0 4px #e9bf5416,0 0 30px #0db16a22!important}.submit,.primary{background:linear-gradient(100deg,#0b5a3b,#e1b64e,#0a6a43)!important;color:#fff7db!important;background-size:220%!important;animation:ramButton 3.2s linear infinite!important;box-shadow:0 12px 35px #d7ac4525!important}@keyframes ramButton{50%{background-position:100%;box-shadow:0 12px 45px #e6bd5740}}
.menuBtn,.toolBtn,.filterChip,.action button,.editClose,.heroTools button,.lang,.lang button{background:#061912!important;border-color:#806631!important;color:#efd17e!important}.filterChip.active{background:#17472f!important;border-color:#e4bd5d!important;color:#fff0b6!important}.drawer{background:linear-gradient(180deg,#0a281c,#020b08)!important;border-color:#b28d3e66!important}.avatar2{background:radial-gradient(circle at 35% 30%,#ffe8a0,#d2a343 50%,#0d5938 100%)!important;color:#062217!important;box-shadow:0 0 40px #e7bb5555!important}.nav a.active{background:linear-gradient(90deg,#0c5b3b88,transparent)!important;color:#f4d77f!important}.nav a.active:before{background:#f1c95f!important;box-shadow:0 0 12px #f1c95f!important}
.hero-border,.motion-border{background:linear-gradient(110deg,#0b4f35,#efc65e,#0b4f35)!important;background-size:220%!important;animation:ramBorder 3s linear infinite!important}@keyframes ramBorder{to{background-position:220%}}.keyicon.on{color:#f4d171!important;background:#123c28!important;border-color:#e6bd5faa!important;box-shadow:0 0 12px #e6bd5f77,0 0 30px #0ec27333!important}.keyicon.off{color:#bb9160!important;background:#26180d!important;border-color:#805e3d!important}.beam,.logProgress{background:linear-gradient(90deg,transparent,#15945f,#f4d26f,#15945f,transparent)!important;box-shadow:0 0 15px #e4ba54!important}.lamp{background:#0d4a31!important;border-color:#efca69!important;box-shadow:0 0 28px #e9c35b44!important}.toast{border-color:#8e7138!important;background:#061711f2!important;box-shadow:0 18px 55px #000b,0 0 30px #d9ae4622!important}.toastIcon{background:linear-gradient(135deg,#0d6c47,#e4ba55)!important;color:#fff3c5!important}
.card,.serverCard,.statCard,.fx,.insight,.keyRow,.pageHero{animation:ramCardIn .65s cubic-bezier(.16,.9,.2,1) both}@keyframes ramCardIn{from{opacity:0;transform:translateY(22px) scale(.975);filter:blur(6px)}to{opacity:1;transform:none;filter:none}}.card:hover,.serverCard:hover,.statCard:hover,.fx:hover,.insight:hover{transform:translateY(-5px)!important;border-color:#e7c26099!important;box-shadow:0 30px 80px #000b,0 0 32px #e5bb4d18!important}.keyRow{transition:.3s}.keyRow:hover{background:#0c2c1f!important;transform:translateX(3px)}
.ramLoader{position:fixed;inset:0;z-index:99999;display:grid;place-items:center;background:radial-gradient(circle at 50% 40%,#0c4b3228,transparent 30%),#020a07;transition:opacity .65s,visibility .65s}.ramLoader.hide{opacity:0;visibility:hidden}.ramLoadInner{text-align:center;color:#f7d77c}.ramLoadMoon{width:82px;height:82px;margin:auto;border-radius:50%;background:#f5d67c;position:relative;box-shadow:0 0 45px #f1c85866;animation:loadMoon 1.7s ease-in-out infinite}.ramLoadMoon:after{content:"";position:absolute;width:72px;height:72px;left:22px;top:-6px;border-radius:50%;background:#020a07}@keyframes loadMoon{50%{transform:translateY(-7px) rotate(4deg);filter:brightness(1.2)}}.ramLoadInner h2{font:700 24px Georgia;margin:18px 0 7px;letter-spacing:2px}.ramLoadInner p{font:700 9px monospace;letter-spacing:3px;color:#a78b50}.ramLoadBar{width:210px;height:3px;background:#173527;margin:18px auto 0;overflow:hidden}.ramLoadBar i{display:block;width:45%;height:100%;background:linear-gradient(90deg,transparent,#f3ca64,transparent);animation:loadBar 1.1s linear infinite}@keyframes loadBar{from{transform:translateX(-110%)}to{transform:translateX(260%)}}
.ramWait{position:fixed;left:50%;bottom:25px;z-index:9998;transform:translate(-50%,130px);opacity:0;transition:.35s;padding:10px 16px;border:1px solid #b08a3e66;background:#061912ed;color:#f3d379;border-radius:999px;font:800 10px monospace;box-shadow:0 10px 35px #0009}.ramWait.show{transform:translate(-50%,0);opacity:1}.ramWait i{display:inline-block;width:14px;height:14px;margin-right:8px;vertical-align:-3px;border:2px solid #f0ca6350;border-top-color:#f0ca63;border-radius:50%;animation:waitSpin .7s linear infinite}@keyframes waitSpin{to{transform:rotate(360deg)}}
.ramRipple{position:fixed;border-radius:50%;pointer-events:none;z-index:9999;width:12px;height:12px;background:#f7d56a55;box-shadow:0 0 25px #f7d56a;animation:ripple .65s ease-out forwards}@keyframes ripple{to{transform:scale(8);opacity:0}}
.server.show,.keysPage.show,#dashboardPage,#logsPage{animation:ramPage .55s cubic-bezier(.2,.8,.2,1)}@keyframes ramPage{from{opacity:0;transform:translateY(18px) scale(.985);filter:blur(4px)}}
@media(max-width:760px){.ramMoon{width:75px;height:75px;right:3vw}.ramMoon:after{width:68px;height:68px;left:20px}.ramLantern.l2,.ramLantern.r1{display:none}.ramMosque{height:100px}}
</style></head><body><div class="ramadanSky"></div><div class="ramMoon"></div><div class="ramStar">✦</div><div class="ramMosque"></div><div class="ramLantern l1"></div><div class="ramLantern l2"></div><div class="ramLantern r1"></div><div class="ramLantern r2"></div><div class="ramParticles" id="ramParticles"></div><div class="ramLoader" id="ramLoader"><div class="ramLoadInner"><div class="ramLoadMoon"></div><h2>RAMADAN KAREEM</h2><p>PREPARING YOUR MAJLIS</p><div class="ramLoadBar"><i></i></div></div></div><div class="ramWait" id="ramWait"><i></i>PLEASE WAIT • جاري التنفيذ</div><div class="ramadanLoader" id="ramadanLoader"><div class="loaderCore"><div class="loaderMoon"></div><div class="loaderLantern"></div><b>رمضان كريم</b><small>لحظات من الصبر والنور...</small><div class="sabrDots"><i></i><i></i><i></i></div></div></div><div class="ramadanStage"></div><div class="ramadanLanterns" id="ramadanLanterns"></div><div class="ramadanMosque"></div><div class="ramadanParticles" id="ramadanParticles"></div><div class="luxDust" id="luxDust"></div><div class="chandelier left"></div><div class="chandelier right"></div><div class="luxFloor"></div><div class="goldCrest">RAMADAN MAJLIS</div><div class="mantel"><i class="mc" style="--h:34px"></i><i class="mc" style="--h:48px"></i><i class="mc" style="--h:27px"></i><i class="mc" style="--h:41px"></i></div><div class="luxHalo" id="luxHalo"></div>
...
</svg></div><div class="brand"><small>CHETO // CONTROL</small><h1>Ramadan Access</h1><span class="live"><i class="dot"></i>SYSTEM READY</span></div></section>
...
</script><button class="pixelCandle" type="button" title="Ambient candle" aria-label="Toggle ambient candle" onclick="document.body.classList.toggle('candleDim');localStorage.setItem('gold_candle',document.body.classList.contains('candleDim')?'1':'0')"><span class="pxc"><i class="flame"></i><i class="wick"></i><i class="wax"></i></span><small>AMBIENT</small></button><script>if(localStorage.getItem('gold_candle')==='1')document.body.classList.add('candleDim');</script><script>(function(){const d=document.getElementById('luxDust');if(d&&!d.children.length){for(let i=0;i<40;i++){let x=document.createElement('i');x.style.left=((i*37)%100)+'%';x.style.top=((i*61)%100)+'%';x.style.setProperty('--t',(6+(i%9))+'s');x.style.setProperty('--o',(.15+(i%5)*.09));x.style.setProperty('--x',((i%2?1:-1)*(8+(i%24)))+'px');d.appendChild(x)}}const h=document.getElementById('luxHalo');if(h)document.addEventListener('pointermove',e=>{h.style.left=e.clientX+'px';h.style.top=e.clientY+'px'});})();</script><script>
(function(){
 const L=document.getElementById('ramadanLanterns');
 if(L&&!L.children.length){[5,16,29,43,58,72,86,96].forEach((x,i)=>{const n=document.createElement('i');n.className='rLantern';n.style.left=x+'%';n.style.setProperty('--drop',(34+(i%4)*18)+'px');n.style.setProperty('--speed',(2.2+(i%3)*.55)+'s');n.style.setProperty('--rot',((i%2?1:-1)*(5+(i%3)*2))+'deg');L.appendChild(n)})}
 const P=document.getElementById('ramadanParticles');
 if(P&&!P.children.length){for(let i=0;i<46;i++){const n=document.createElement('i');n.style.left=((i*37)%100)+'%';n.style.top=((i*71)%100)+'%';n.style.setProperty('--dur',(8+(i%9))+'s');n.style.setProperty('--op',(.15+(i%6)*.09));n.style.setProperty('--dx',((i%2?1:-1)*(10+(i%40)))+'px');n.style.animationDelay=(-i*.37)+'s';P.appendChild(n)}}
 window.addEventListener('load',()=>setTimeout(()=>document.getElementById('ramadanLoader')?.classList.add('hide'),650));
 setTimeout(()=>document.getElementById('ramadanLoader')?.classList.add('hide'),2200);
 document.addEventListener('click',e=>{const r=document.createElement('span');r.className='ramadanRipple';r.style.left=e.clientX+'px';r.style.top=e.clientY+'px';r.style.width=r.style.height='18px';document.body.appendChild(r);setTimeout(()=>r.remove(),750)});
 const obs=new IntersectionObserver(es=>es.forEach(x=>{if(x.isIntersecting){x.target.style.animation='ramadanReveal .62s cubic-bezier(.16,.9,.2,1) both';obs.unobserve(x.target)}}),{threshold:.08});
 document.querySelectorAll('.card,.serverCard,.statCard,.fx,.insight,.keys,.logWrap,.pageHero').forEach(e=>obs.observe(e));
})();
</script><script>
(function(){
 const loader=document.getElementById('ramLoader'); setTimeout(()=>loader&&loader.classList.add('hide'),850);
 const box=document.getElementById('ramParticles'); if(box&&!box.children.length){for(let i=0;i<34;i++){const x=document.createElement('i');x.textContent=i%4===0?'✦':i%7===0?'☾':'•';x.style.left=((i*31)%100)+'%';x.style.setProperty('--t',(7+(i%9))+'s');x.style.animationDelay=(-i*.47)+'s';x.style.fontSize=(7+(i%4)*3)+'px';box.appendChild(x)}}
 document.addEventListener('pointerdown',e=>{if(!e.target.closest('button,a,.nav a,.filterChip'))return;const r=document.createElement('i');r.className='ramRipple';r.style.left=(e.clientX-6)+'px';r.style.top=(e.clientY-6)+'px';document.body.appendChild(r);setTimeout(()=>r.remove(),700)});
 document.addEventListener('submit',()=>{const w=document.getElementById('ramWait');if(w){w.classList.add('show');setTimeout(()=>w.classList.remove('show'),1600)}},true);
 document.addEventListener('click',e=>{if(e.target.closest('.nav a,.menuBtn,.toolBtn,.action button,.primary,.submit')){const w=document.getElementById('ramWait');if(w&&e.target.closest('.action button,.primary,.submit')){w.classList.add('show');setTimeout(()=>w.classList.remove('show'),1200)}}});
 const old=window.page; if(typeof old==='function'){window.page=function(p){const w=document.getElementById('ramWait');if(w){w.classList.add('show');setTimeout(()=>w.classList.remove('show'),420)};setTimeout(()=>old(p),120)}}
})();
</script></body></html>
"""
